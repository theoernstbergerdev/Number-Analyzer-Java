...
public class NumberAnalyzer {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Quantidade de números ímpares: " + quantosImpares);
            System.out.println("O maior número digitado: " + maiorNum);
            System.out.println("O menor número digitado: " + menorNum);
            System.out.println("Fim do programa!");
        }
        catch (IllegalArgumentException e) {
            System.out.println("Erro de Regra: " + e.getMessage());
        }
        catch (InputMismatchException letraInvali) {
            System.out.println("Erro: Você deve digitar um número inteiro, não letras ou símbolos.");
        }
        catch (Exception e) {
